// nav bar for my blog we use the tailwind classes.
  ...
  return (
    <div className='flex justify-between items-center py-5 mx-8 sm:mx-20 x1:mx-32 '>
      {/* curse pointer */}
        ...
        <button onClick={()=> navigate('/admin')}  class='flex items center gap -2 rounded-full text-sm cursor-pointer bg-primary text-white px-10 py-2.5'>Login
